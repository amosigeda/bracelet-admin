			  ...
			  <div id="profile" class="tab-pane">
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<tr>
						<td style="text-align: center;" colspan="100">
							文字水印配置
							<label style="float:left;padding-left: 15px;"><input name="fcheckbox" class="ace-checkbox-2" type="checkbox" id="check1" onclick="openThis1();" />开启</label>
						</td>
					</tr>
					<tr>
				...
				<table id="table_report" class="table table-striped table-bordered table-hover">
					<tr>
						<td style="text-align: center;" colspan="100">
							图片水印配置
							<label style="float:left;padding-left: 15px;"><input name="fcheckbox" class="ace-checkbox-2" type="checkbox" id="check2" onclick="openThis2();" />开启</label>
						</td>
					</tr>
					<tr>
						<td style="width:50px;text-align: right;padding-top: 12px;">X坐标:</td>
