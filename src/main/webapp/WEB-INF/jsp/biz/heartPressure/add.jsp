...
<body>
	<form action="heartPressure/doAdd" name="dataForm" id="dataForm" method="post" >
		<div id="zhongxin">
		<table>
			<tr>
				<td><input type="text" name="maxHeartPressure" id="maxHeartPressure" autocomplete="off" value="" maxlength="8" placeholder="这里输入收缩压" title="收缩压"/></td>
			</tr>
			<tr>
				<td><input type="text" name="minHeartPressure" id="minHeartPressure" autocomplete="off" value="" maxlength="8" placeholder="这里输入舒张压" title="舒张压"/></td>
			</tr>
			<tr>
