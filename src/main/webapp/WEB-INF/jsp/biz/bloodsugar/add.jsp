...
<body>
	<form action="bloodSugar/doAdd" name="dataForm" id="dataForm" method="post" >
		<div id="zhongxin">
		<table>
			<tr>
				<td><input type="text" name="bloodSugar" id="bloodSugar" autocomplete="off" value="" maxlength="8" placeholder="这里输入血糖" title="血糖"/></td>
			</tr>
			<tr>
