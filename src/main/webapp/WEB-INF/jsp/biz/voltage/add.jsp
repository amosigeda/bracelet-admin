...
<body>
	<form action="voltage/doAdd" name="dataForm" id="dataForm" method="post" >
		<div id="zhongxin">
		<table>
			<tr>
				<td><input type="text" name="voltage" id="voltage" autocomplete="off" value="" maxlength="8" placeholder="这里输入电量" title="电量"/></td>
			</tr>
			<tr>
