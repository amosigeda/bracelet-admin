...
<body>
	<form action="safearea/doEdit" name="userForm" id="userForm" method="post" >
		<input type="hidden" name="id" id="id" value="${user.id }"/>
		<div id="zhongxin">
		<table>
		<tr>
				<td><input type="text" name="name" id="name" autocomplete="name" value="${user.name }" maxlength="32" placeholder="这里输入名称" title="名称"/></td>
			</tr>
			<tr>
