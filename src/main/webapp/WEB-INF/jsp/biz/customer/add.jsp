		...
		<table>
			...
			<tr>
				<td>
					...
					<input type="hidden" name="avatar" id="upload_file_base64"/>
				</td>
			</tr>
			<tr>
				<td><input type="text" name="nickname" id="nickname" autocomplete="off" value="" maxlength="32" placeholder="这里输入昵称" title="昵称"/></td>
			</tr>
			<tr>
				<td>
					<input name="sex" id="sex0" type="radio" value="0">男</label>
					<input name="sex" id="sex1" type="radio" value="1">女</label>
					<input name="sex" id="sex2" type="radio" value="2">保密</label>
				</td>
			</tr>
			<tr>
				<td><input type="text" name="weight" id="weight" autocomplete="off" value="" maxlength="8" placeholder="这里输入体重" title="体重"/></td>
			</tr>
			<tr>
				<td><input type="text" name="height" id="height" autocomplete="off" value="" maxlength="8" placeholder="这里输入身高" title="身高"/></td>
			</tr>
			<tr>
				<td><input type="text" name="address" id="address" autocomplete="off" value="" maxlength="255" placeholder="这里输入地址" title="地址"/></td>
			</tr>
			<tr>
