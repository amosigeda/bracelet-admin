...
<body>
	<form action="step/doAdd" name="dataForm" id="dataForm" method="post" >
		<div id="zhongxin">
		<table>
			<tr>
			...
			<tr>
				<td><input type="text" name="stepNumber" id="stepNumber" autocomplete="off" value="" maxlength="8" placeholder="这里输入步数" title="步数"/></td>
			</tr>
			<tr>
