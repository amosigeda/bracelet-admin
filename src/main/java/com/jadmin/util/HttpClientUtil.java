...
public class HttpClientUtil {
	 ...
	 * 带参数post 请求
	 * */
	public static String getHttpClientPostParamter(String url, Map<String, String> map) {
		byte[] rs = null;
		String result = null;
		try {
			HttpClient httpClient = new DefaultHttpClient();
			...
			while (iterator.hasNext()) {
				...
				Object object = entry.getValue();
				formparams.add(new BasicNameValuePair(entry.getKey(), (String) object));
			}
	...
	public static void main(String[] args) {
		...
		//	            }
		//	        }
		//		String url = "http://tthemestyle.jadmin.com/apitheme/themezip/20131202162745/lu:sexinqing.zip";
