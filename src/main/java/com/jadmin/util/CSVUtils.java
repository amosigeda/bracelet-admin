...
public class CSVUtils {
	...
	public static void createCSVFile(List exportData, LinkedHashMap rowMapper, OutputStream outPutPath, String filename) {
		File csvFile = null;
		...
		try {
			...
			CloseableUtil.close(csvFileOutputStream);
		}
